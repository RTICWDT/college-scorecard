        ...
        <v-row>
          <v-col cols="12" md="10" offset-md="1">
            <v-card class="py-5 px-10 ma-5">
              ...
              <p>
                Download the data that appear on the College Scorecard, as well
                as supporting data on student completion, debt and repayment,
                ...
                <li class="font-weight-bold">
                  ...
                  <ul class="font-weight-regular">
                    ...
                    <li>
                      ...
                      4-digit CIP code combination for each institution.
                      Includes information on cumulative debt at graduation and
