  ...
  <div class="v-application-override">
    <div class="justify-center" style="background:#fff;width:100%;padding-top:105px;">    
        <v-container><v-row class="ml-2">
          <v-col cols="1" class="justify-end"><img :src="$url('/img/icon-Note.svg')" alt="Note Icon" style="vertical-align: middle;float:right;"/></v-col>
               ...
               <v-container>
                 <v-row align="center">
                   <v-col cols="12" lg="6" md="12" sm="12">
                     ...
                     <p class="pr-16">Search nearby schools that accept Pell Grants, and may also have eligible training programs for participants in Workforce Innovation and Opportunity Act (WIOA) programs. If you need help taking the next step in your career, find an <a :href="$url('/school/transition/')"
                        target="_blank"
                        @click="transitionOutboundLink($event, 'https://www.careeronestop.org/LocalHelp/AmericanJobCenters/american-job-centers.aspx')">American Job Center<v-icon
                      x-small
                      class="pl-1"
                    >
                      fas fa-external-link-alt
                    </v-icon></a>. In some states, Unemployment Insurance (UI) recipients can attend school or training and continue to receive UI benefits (<a :href="$url('/school/transition/')"
                        target="_blank"
                        @click="transitionOutboundLink($event, 'https://www.dol.gov/general/topic/unemployment-insurance')">learn more about UI benefits<v-icon
                      x-small
                      class="pl-1"
                    >
                      fas fa-external-link-alt
                   ...
                   <v-col cols="12" lg="6" md="12" sm="12" align="center">
                    ...
                    <p class="text-center home-callout-button-wrapper justify-center py-3 my-5">
                      ...
                      >
                      <img :src="$url('img/icon-Location.svg')" alt="Department of Labor Icon" class="py-3 pl-3 pr-1"/> SEARCH NEARBY SCHOOLS
...
.v-application-override {
    ...
    background-image: linear-gradient(to bottom, rgba(39, 113, 173, .24) 30%, rgba(0, 54, 94, 1) 30% 65%, rgba(39, 113, 173, 1) 65% 100%), url("data:image/svg+xml,%3Csvg width='84' height='48' viewBox='0 0 84 48' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 0h12v6H0V0zm28 8h12v6H28V8zm14-8h12v6H42V0zm14 0h12v6H56V0zm0 8h12v6H56V8zM42 8h12v6H42V8zm0 16h12v6H42v-6zm14-8h12v6H56v-6zm14 0h12v6H70v-6zm0-16h12v6H70V0zM28 32h12v6H28v-6zM14 16h12v6H14v-6zM0 24h12v6H0v-6zm0 8h12v6H0v-6zm14 0h12v6H14v-6zm14 8h12v6H28v-6zm-14 0h12v6H14v-6zm28 0h12v6H42v-6zm14-8h12v6H56v-6zm0-8h12v6H56v-6zm14 8h12v6H70v-6zm0 8h12v6H70v-6zM14 24h12v6H14v-6zm14-8h12v6H28v-6zM14 8h12v6H14V8zM0 8h12v6H0V8z' fill='%233d82b1' fill-opacity='0.24' fill-rule='evenodd'/%3E%3C/svg%3E") !important;  
}
.home-splash {
  min-height: 200px;
  padding-top: 2rem;
