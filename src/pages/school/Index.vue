                      ...
                      <em
                        ...
                        {{
                          this.$options.filters.numeral(
                            this.medianToggle === "group"
                              ? Math.round(
                                  parseFloat(fakeMedianEarnings[groupName][0])
                                )
                              : Math.round(
                                  parseFloat(fakeMedianEarnings[groupName][1])
                                ),
                            "$0,0"
                          )
                        }}</em
                ...
                <v-expansion-panel class="fos-profile-panel" elevation="0">
                  ...
                  >
                    ...
                    <p class="text-left my-8">
                      ...
                      >
                        <span class="d-none d-sm-flex"
                          >See All Available Fields of Study at {{ schoolName }}
                        </span>
                    ...
                    <p class="pa-4 rounded yellow-warn mt-4 mb-8">
                      ...
                      undergradute students who received federal financial aid.
                    </p>
                  </v-expansion-panel-content>
                </v-expansion-panel>
              </v-expansion-panels>
                    ...
                    <div v-else>
                      <v-row>
                        ...
                        <v-col cols="12" md="6">
                          ...
                          <div
                            v-if="monthlyLoanPayment && aidLoanSelect === 'fed'"
                          >
                            <div
                              class="display-2 navy-text font-weight-bold pb-3"
                            >
                          ...
                          <p class="mt-3 mb-0 pb-15">
                            ...
                            amount that is intended to be affordable based on
                ...
                <v-expansion-panel class="institution-profile-panel">
                  ...
                  >
                    <div>
                      ...
                      <p class="mt-2">
                        Salary information for Fields of Study available at this
                        school are in the
                        <a :href="this.$url(fieldsLink)">All Fields of Study</a>
                        page.
                      </p>
                    </div>
                  </v-expansion-panel-content>
                  ...
                  >
                    <v-row>
                      ...
                      <v-col cols="12" md="5">
                        ...
                        <div
                          v-if="
                            openAdmissions != 1 && acceptanceRateActual != null
                          "
                        >
                          <donut
                            color="#1874DC"
