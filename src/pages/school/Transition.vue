        ...
        <v-row>
          <v-col cols="12" sm="8" offset-sm="2">
            <v-card class="pa-5">
              ...
              <p>
                Links are provided by the institutions and are only updated
                about once a year. As such, over the course of the year, some
                links may break or websites may be taken offline.
              </p>
              <div
              ...
              <div v-else class="d-flex">
                <v-btn
                  class="mb-1 mr-2 transition-button"
                  color="secondary"
                  :href="url"
                  v-if="url"
                  >Continue to Website</v-btn
