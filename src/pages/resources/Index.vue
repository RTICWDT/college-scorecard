          ...
          <v-col cols="12" md="6">
            ...
            <div class="d-flex">
              ...
              <div>
                ...
                <p>A detailed roadmap to assist the instructor in seamlessly delivering each activity.</p>
              </div>
            </div>
            <Spacer :height="20" />
            <div class="d-flex">
              ...
              <div>
                ...
                <p>Dynamic presentation slides to guide instructors and captivate students throughout the lessons.</p>
              </div>
            </div>
            <Spacer :height="20" />
            <div class="d-flex">
              ...
              <div>
                ...
                <p>Supplementary materials to support student learning and engagement during activities.</p>
              </div>
            </div>
          </v-col>
          <v-col cols="12" md="6">
            ...
            <div class="content-box">
              ...
              <br />
              <hr>
              <a href="https://drive.google.com/drive/folders/1GVcbgjMrwGEw3RhJNnex0UpZBYMP4xpz?usp=sharing" target="_blank" rel="noreferrer" class="content-link mb-0"><img :src="$url('img/icon-google-drive.svg')" alt="Google Drive" class="mr-1" width="17px" height="17px"/>View on Google Drive</a>
            </div>
          </v-col>
        </v-row>
        <Spacer />
            ...
            <v-col cols="12" md="6">
              ...
              <div class="d-flex">
                ...
                <div>
                  ...
                  <p>A step-by-step manual to help instructors seamlessly navigate through the training sessions.</p>
                </div>
              </div>
              <Spacer :height="20" />
              <div class="d-flex">
                ...
                <div>
                  ...
                  <p>Engaging presentation slides to facilitate learning and stimulate discussions during training sessions.</p>
                </div>
              </div>
              <Spacer :height="20" />
              <div class="d-flex">
                ...
                <div>
                  ...
                  <p>Visual aids and supplementary materials to complement the training sessions and reinforce key concepts.</p>
                </div>
              </div>
            </v-col>
            <v-col cols="12" md="6">
              ...
              <div class="content-box">
                ...
                <br />
                <hr>
                <a href="https://drive.google.com/drive/folders/1p9KbEtwyB8HmNQ5dOfo04g8lwuXUnrmh?usp=sharing" target="_blank" rel="noreferrer" class="content-link mb-0"><img :src="$url('img/icon-google-drive.svg')" alt="Google Drive" class="mr-1" width="17px" height="17px"/>View on Google Drive</a>
              </div>
            </v-col>
          </v-row>
          <Spacer />
