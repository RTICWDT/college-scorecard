<template>
  <div>
    <div>
      <p class="outcomes_intro d-inline-block mb-2">
...
export default {
  ...
  methods: {
    updateSankey() {
      ...
      this.trackOutcome(
        this.enroll.substring(7).replace(/_/g, " ") +
          " " +
          this.study.substring(6).replace(/_/g, " ")
      )
    },
  },
}
