...
export default function (Vue, { router, head, isClient, appOptions }) {
  ...
  head.meta.push({
    ...
    content: "default-src 'unsafe-inline' 'unsafe-eval'; img-src 'self' data: *.cloud.gov; child-src 'none'; script-src-elem * 'unsafe-inline'; style-src-elem 'self' 'unsafe-inline'; prefetch-src 'self'; connect-src https://api.data.gov 'self'; font-src 'self'"
  })
  head.meta.push({
    name: 'og:type',
    content: 'website'
