...
export default function (Vue, { router, head, isClient, appOptions }) {
  ...
  head.meta.push({
    ...
    content: "default-src 'unsafe-inline' 'unsafe-eval' 'self'; img-src 'self' data: *.cloud.gov *.googleapis.com; child-src 'none'; script-src-elem * 'unsafe-inline'; style-src-elem 'self' 'unsafe-inline'; connect-src https://api.data.gov https://www.google-analytics.com 'self'; font-src 'self'; style-src 'self'; frame-src https://vars.hotjar.com"
  })
  head.meta.push({
    name: 'og:type',
    content: 'website'
