...
export default function (Vue, { router, head, isClient, appOptions }) {
  ...
  head.meta.push({
    ...
    content: "default-src 'unsafe-inline' 'unsafe-eval'; img-src 'self' data:; child-src 'none'; script-src-elem * 'unsafe-inline'; style-src-elem 'self' 'unsafe-inline'; prefetch-src 'self'; connect-src 'self'"
  })
  head.meta.push({
    name: 'og:type',
    content: 'website'
