              ...
              <v-expansion-panels>
                <v-expansion-panel>                  
                  ...
                  <v-expansion-panel-content>
                    <p>On April 4, 2021, the College Scorecard API was updated to improve stability and efficiency. If you encounter any problems with this revision of the API, please submit an issue at <a href="http://github.com/rticwdt/college-scorecard/">http://github.com/rticwdt/college-scorecard/</a></p>
                    <p>Changes include: </p>
                    <ul><li><strong>By default, only “<em>latest</em>” data will be returned.</strong> Before this update, the API returned data for all years available unless filtered by the fields parameter. With this update, it now returns only the <em>latest</em> object by default. If your implementation relies on the previous functionality, the flag <em>“&all_years=true”</em> can be appended to your API call to receive data for all years available.</li>
                    ...
                    <li>School name autocomplete improvements. An autocomplete endpoint for institution name is now available. This endpoint takes into account institution aliases and returns IDs and a relevance score based on the text string sent. Individual words must be at least three characters long to produce results. The new endpoint is:
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <ul class="my-3">
                      ...
                      <li>The website was updated to include profiles for currently operating non-Title IV institutions.</li>
                    </ul>
                  </v-expansion-panel-content>
                </v-expansion-panel>
                <v-expansion-panel>
                  <v-expansion-panel-header>May 21, 2019</v-expansion-panel-header>
                  <v-expansion-panel-content>
                    ...
                    <p>The data section provides a data file with preliminary cumulative loan debt data for college graduates by field of study.</p>
                  </v-expansion-panel-content>
                </v-expansion-panel>
                <v-expansion-panel>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>September 28, 2018</v-expansion-panel-header>
                  <v-expansion-panel-content>
                    <p>
                    ...
                    <ul class="my-3">
                      ...
                      <li>
                        ...
                        <ul class="my-3">
                          ...
                          <li>Removal of the national median indicators. On bar charts, the lines that once indicated the national median were removed. Additionally, the arrows and text that stated whether an institution was above or below the national median have also been removed.</li>
                        </ul>
                      </li>
                    </ul>
                    <hr />
                    <p class="footnote">
                      <sup>1</sup> NSLDS -derived data elements will also be updated in the fall of 2018
                      <br />
                    </p>
                  </v-expansion-panel-content>
                </v-expansion-panel>
                <v-expansion-panel>
                  <v-expansion-panel-header>September 6, 2018</v-expansion-panel-header>
                  <v-expansion-panel-content>
                    <p>
                    ...
                    <hr />
                    <p class="footnote">
                      <sup>1</sup> NSLDS and Treasury Department derived data elements will also be updated in the fall of 2018
                    </p>
                  </v-expansion-panel-content>
                </v-expansion-panel>
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <ul class="my-3">
                      ...
                      <li>The institution profile page currently displays the predominant degree awarded by the institution. If the institution offers additional degrees and/or certificates, this is now noted in the tooltip.</li>
                      <li>The retention rate variable used on the institution profile and comparison pages has been updated to reference the new pooled data variable.</li>
                      <li>Certificate programs are now included in list of Available Programs on the institution page.</li>
                    </ul>
                  </v-expansion-panel-content>
                </v-expansion-panel>
                <v-expansion-panel>
                  <v-expansion-panel-header>December 2017</v-expansion-panel-header>
                  <v-expansion-panel-content>
                    <p>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>September 2017</v-expansion-panel-header>
                  <v-expansion-panel-content>
                    <p>
                      <strong>Consumer Website:</strong> In September 2017, the U.S. Department of Education (the Department)
                    ...
                    <p>
                      <strong>Downloadable Data Files and API:</strong> In addition to providing newer, updated data in the
                    ...
                    <ul class="my-3">
                      ...
                      <li>
                        ...
                        <ul class="my-3">
                          ...
                          <li>Number of undergraduate non-degree-seeking students enrolled in the fall of the academic year</li>
                          <li>Number of graduate students enrolled in the fall of the academic year</li>
                          <li>Number of students in the adjusted cohort for the 150% completion rate calculations by race</li>
                          <li>PEPS code corresponding to the accrediting agency provided in the Scorecard data file</li>
                          <li>Earliest date of initial Title IV approval for any location associated with each IPEDS UNITID</li>
                        </ul>
                      </li>
                      <li>
                    ...
                    <p>* The Department updated all downloadable data files on October 2, making additional values available from NSLDS-derived data (e.g. the 2012-2013 data file)</p>
                  </v-expansion-panel-content>
                </v-expansion-panel>
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <p>After identifying an error in the code that generates repayment rates, the Department fixed the error and recalculated all repayment rates and replaced the previously published repayment rate data values with revised values. The error was a technical one in the coding that caused undercounting of some borrowers who had not reduced their balances, and therefore inflated repayment rates for almost all schools. This revision includes all repayment rate data values in all of the merged data files and all versions of repayment rates including repayment rates for each repayment rate cohort, the 1-, 3-, 5-, 7-year repayment rates, and all repayment rates disaggregated by demographic category (e.g. first-generation status, gender, etc.). The relative difference—that is, whether schools fall above, about, or below average— is modest; over 90 percent of institutions on the College Scorecard tool do not change categories from the previously published to the new rates. However, in some cases, the nominal differences are significant.</p>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>September 2016</v-expansion-panel-header>
                  <v-expansion-panel-content>
                    <p>
                        ...
                        <ul class="my-3">
                          ...
                          <li>
                            ...
                            <ul class="my-3">
                              ...
                              <li>
                                The average and median family income of students (FAMINC and MD_FAMINC) and separately of independent students (FAMINC_IND)
                                <sup>2</sup>;
                              </li>
                            </ul>
                          </li>
                        ...
                        <ul class="my-3">
                          <li>
                            ...
                            <ul class="my-3">
                              ...
                              <li>Total share of enrollment of undergraduate degree-seeking students who are women</li>
                              <li>Completion rate for first-time, full-time students at four-year institutions (100% of expected time to completion/6 years)</li>
                              <li>Completion rate for first-time, full-time students at less-than-four-year institutions (100% of expected time to completion)</li>
                              <li>Adjusted cohort count for completion rate at four-year institutions (denominator of 100% completion rate)</li>
                              <li>Adjusted cohort count for completion rate at less-than-four-year institutions (denominator of100% completion rate)</li>
                              <li>Transfer rate for first-time, full-time students at four-year institutions (within 150% of expected time to completion/6 years)</li>
                              <li>Transfer rate for first-time, full-time students at less-than-four-year institutions (150% of expected time to completion)</li>
                              <li>Adjusted cohort count for transfer rate at less-than-four-year institutions (denominator of 150% transfer rate)</li>
                              <li>Adjusted cohort count for transfer rate at four-year institutions (denominator of 150% transfer rate)</li>
                              <li>Number of students in the cohort for the three-year cohort default rate</li>
                              <li>Number of students in the cohort for the two-year cohort default rate</li>
                            </ul>
                          </li>
                        </ul>
                      </li>
                    ...
                    <p class="footnote">
                      <sup>2</sup> NSLDS calculations of the percentage of students in each income groups are based on nominal dollar values (not adjusted for inflation). This methodology differs from the way the Treasury Department identified income groups (with inflation adjustments) for disaggregated earnings calculations.
                    </p>
                    <p class="footnote">
                    ...
                    <p class="footnote">
                      <sup>4</sup> In the previous version of Scorecard, if a student separated and then went back and got further undergraduate loans at the same institution after separation and prior to October 2014 (time of measurement), then those additional loans would be included in the total.
                    </p>
                    <p class="footnote">
                      <sup>5</sup> This information recalculated by the Department of Education is available under the data elements APPL_SCH_PCT_GE*.
                    </p>
                  </v-expansion-panel-content>
                </v-expansion-panel>
                <v-expansion-panel>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>February 2016</v-expansion-panel-header>
                  <v-expansion-panel-content>
                    <p>In February 2016, the Department expanded the number of institutions that are presented on the College Scorecard consumer website to include roughly 700 less-than-two-year institutions (institutions that predominately award undergraduate certificates) that offer and award Associate and/or Bachelor’s degrees. The previous version of the consumer website did not include these predominantly less-than-two-year institutions.</p>
                  </v-expansion-panel-content>
                </v-expansion-panel>
              </v-expansion-panels>
            </v-card>
