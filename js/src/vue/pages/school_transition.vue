          ...
          <v-row>
              <v-col cols="12" sm="8" offset-sm="2">
                  <v-card class='pa-5'>
                      ...
                      <v-btn class="mb-1" color="secondary" rounded :href="url" v-if="url">Continue to Website</v-btn>    
                      <span v-else class='px-4 mb-1'><v-icon small>fas fa-exclamation-triangle</v-icon> Invalid URL</span>    
                      <v-btn class="mb-1" rounded :href="referrer">Return to Previous Page</v-btn>                    
                  </v-card>
              </v-col>
