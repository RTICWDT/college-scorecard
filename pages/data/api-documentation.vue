<template>
    <DocumentationCard title="API Documentation">
      ...
      <p>
        ...
        be found in the
        <a @click="trackDownload('CollegeScorecardDataDictionary.xlsx')"
          :href="'~assets/files/CollegeScorecardDataDictionary.xlsx'" target="_blank">Data Dictionary</a>.
        Additional context for the data elements can also be found in
        the documentation reports for
        <a @click="trackDownload('InstitutionDataDocumentation.pdf')"
          :href="'~assets/files/InstitutionDataDocumentation.pdf'" target="_blank">institution-level data</a>
        and
        <a @click="trackDownload('FieldOfStudyDataDocumentation.pdf')"
          :href="'~assets/files/FieldOfStudyDataDocumentation.pdf'" target="_blank">field of study data</a>.
      </p>
      <p>
      ...
      <p>
        ...
        <a @click="trackDownload('CollegeScorecardDataDictionary.xlsx')"
          href="/assets/CollegeScorecardDataDictionary.xlsx">data dictionary</a>. Sorting is only available on
      ...
      <v-btn @click="trackDownload('CollegeScorecardDataDictionary.xlsx')" size="large" color="secondary"
        href="/assets/CollegeScorecardDataDictionary.xlsx" class="button data-home-button mb-4">Download the Data
