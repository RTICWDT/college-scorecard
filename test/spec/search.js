...
describe('search', function() {
  ...
  */
  it('should contain all schools in Delaware if selected', function*() {
    ...
    assert.equal(yield utils.getSearchCount(), results.spotChecks.allInDelaware);
  });
  ...
  it('should contain all schools in DE & KY if selected', function*() {
    ...
    assert.equal(yield utils.getSearchCount(), results.spotChecks.allInDelawareKentucky);
  });
  ...
  it('should contain all schools in Zip Code 10023', function*() {
    ...
    assert.equal(yield utils.getSearchCount(), results.spotChecks.allIn10023NoRadius);
  });
  ...
  it('should contain all schools within 5 miles of Zip Code 10023', function*() {
    ...
    assert.equal(yield utils.getSearchCount(), results.spotChecks.allIn10023Radius5);
  });
  ...
  */
  ...
  it('should contain all small and large schools if selected', function*() {
    ...
    assert.equal(yield utils.getSearchCount(), results.spotChecks.allSmallAndLarge);
  });
  ...
  it('should contain only associate degrees if selected', function*() {
    ...
    assert.equal(yield utils.getSearchCount(), results.spotChecks.allAssociates);
  });
  ...
  */
  ...
  it('should contain only private schools if selected', function*() {
    ...
    assert.equal(yield utils.getSearchCount(), results.spotChecks.allPrivateNonProfit);
  });
  ...
  it('should contain only for profit schools if selected', function*() {
    ...
    assert.equal(yield utils.getSearchCount(), results.spotChecks.allPrivateForProfit);
  });
});
